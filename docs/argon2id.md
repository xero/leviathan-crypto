...
- [sha2.md](./sha2.md): HKDF-SHA256 — key expansion from Argon2id root keys
- [serpent.md](./serpent.md): SerpentSeal — Serpent-256 authenticated encryption
- [chacha20.md](./chacha20.md): XChaCha20Poly1305 — ChaCha20 authenticated encryption
