...
> - [chacha20](./chacha20.md) — `XChaCha20Seal` implements `AEAD`; `XChaCha20Cipher` is a `CipherSuite` for `SealStream`/`OpenStream`; `ChaCha20`/`ChaCha20Poly1305`/`XChaCha20Poly1305` are stateless primitives
