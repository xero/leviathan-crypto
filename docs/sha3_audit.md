...
| Target: | `leviathan-crypto` AssemblyScript WASM implementation |
| Spec: | FIPS 202 (SHA-3 Standard, August 2015) |
| Variants: | SHA3-224, SHA3-256, SHA3-384, SHA3-512, SHAKE128, SHAKE256 |
| Test vectors: | FIPS 202 §A (per-variant KAT), Python `hashlib` cross-check, multi-block boundary cases |
