...
> [!NOTE]
> A CSPRNG that continuously collects entropy from the environment and
> generates cryptographically secure random bytes. The cipher and hash
> primitives are pluggable; you pick which pair to use at create time.
