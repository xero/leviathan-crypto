...
This low-level reference details the Kyber AssemblyScript source and WASM exports, intended for those auditing, contributing to, or building against the raw module. **Most consumers should instead use the [TypeScript wrapper](./kyber.md) or the higher-level [AEAD classes](./aead.md#kybersuite).**
