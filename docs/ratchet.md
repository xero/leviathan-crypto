...
> [!NOTE]
> KDF primitives from Signal's Sparse Post-Quantum Ratchet (Double Ratchet
> spec §5 + §7.2): `ratchetInit`, `KDFChain`, `kemRatchetEncap`,
> `kemRatchetDecap`, `SkippedKeyStore`, and `RatchetKeypair`. Provides key
> derivation, skipped-key management, and single-use KEM lifecycle.
