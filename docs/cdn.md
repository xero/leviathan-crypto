...
> [!NOTE] leviathan-crypto is published to npm and mirrored on
> [unpkg](https://unpkg.com). All `WasmSource` types work directly from the CDN
> with no install or bundler required.
