...
| `sha2/sha256.test.ts` | SHA-256 vectors, streaming, wipeBuffers, leviathan cross-check | 5 tests | Gate 3 |
| `sha2/sha512.test.ts` | SHA-512, SHA-384 vectors, streaming, leviathan cross-check | 6 tests | Gate 4 |
| `sha2/hmac.test.ts` | HMAC-SHA256/512/384 vectors, leviathan cross-check | 8 tests | Gate 5, 6 |
...
| `sha3/sha3.test.ts` | SHA3-224/256/384/512, SHAKE128/256 (single + multi-block), incremental absorb/squeeze, state machine guards, dispose zeroes TS buffer, wipeBuffers, leviathan cross-check | 25 tests | Gate 7 |
| `sha3/shake_xof.test.ts` | SHAKE128/256 multi-squeeze KAT: rate-boundary crossing (MS-1–3, MS-5–7), byte-by-byte squeeze (MS-4, MS-8), reset after multi-squeeze (MS-9) | 5 tests | — |
...
41 tests × 3 browsers (Chromium, Firefox, WebKit) = 123 total.
