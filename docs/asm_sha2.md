...
This low-level reference details the SHA-2 AssemblyScript source and WASM exports, intended for those auditing, contributing to, or building against the raw module. **Most consumers should instead use the [TypeScript wrapper](./sha2.md).**
...
Passes through directly to `sha256Update(len)`. The inner hash accumulates the message data.
...
### SHA-512 / SHA-384 Region (offsets 620 to 1975)
