...
Audit of the `leviathan-crypto` HKDF-SHA256 TypeScript implementation (pure composition over the already-audited HMAC primitive) against RFC 5869, verified against all RFC 5869 Appendix A test vectors.
