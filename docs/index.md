...
|--------|------|-------------|
| `init` | function | Load and cache WASM modules. Must be called before using any class. |
...
### Serpent (`serpent/index.ts`) -- requires `init(['serpent'])`
...
### ChaCha20 (`chacha20/index.ts`) -- requires `init(['chacha20'])`
...
### SHA-2 (`sha2/index.ts`) -- requires `init(['sha2'])`
...
### SHA-3 (`sha3/index.ts`) -- requires `init(['sha3'])`
