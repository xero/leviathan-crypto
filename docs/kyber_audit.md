...
Audit of the `leviathan-crypto` WebAssembly ML-KEM implementation (AssemblyScript) against FIPS 203, covering all three parameter sets (ML-KEM-512, ML-KEM-768, ML-KEM-1024) and verified against NIST ACVP vectors.
...
| Test vectors: | NIST ACVP (ML-KEM-keyGen-FIPS203, ML-KEM-encapDecap-FIPS203) |
