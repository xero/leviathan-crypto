 ...
 *
 * usage: bunx tsx scripts/gen-sealstream-vectors.ts
...
const xc1_header = xc1_sealer.preamble;
...
const xc3_header = xc3_sealer.preamble;
...
const sc1_header = sc1_sealer.preamble;
...
const sc3_header = sc3_sealer.preamble;
...
const xcf1_header = xcf1_sealer.preamble;
...
const scf1_header = scf1_sealer.preamble;
