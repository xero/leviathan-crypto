...
// Cross-checks the HKDF step against ACVP tcId 77 sharedSecret without
// instantiating the full mlkem / sha3 stack (sha2 only).
...
// without pulling in the full mlkem WASM stack.
