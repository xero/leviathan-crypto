...
export const UNIT_GROUPS: readonly TestGroup[] = [
	...
	},
	{
		...
		files: [
			...
			'test/unit/mlkem/mlkem.test.ts',
			'test/unit/mlkem/mlkem_suite.test.ts',
			'test/unit/mlkem/suite-commitment.test.ts',
			'test/unit/mlkem/decap-scratch-wipe.test.ts',
			'test/unit/mlkem/encap-scratch-wipe.test.ts',
			'test/unit/mlkem/keygen-scratch-wipe.test.ts',
			'test/unit/mlkem/sha3-scratch-wipe.test.ts',
		],
	},
	{
		name: 'hashing',
