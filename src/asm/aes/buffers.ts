...
//
// Total: 134464 bytes < 3 × 64KB = 196608 (62144 bytes spare).
//
// Offset    Size      Name
// 0         32        KEY_BUFFER (sized for AES-256 future)
...
// 320       1920      ROUND_KEYS_BUFFER   (15 × 8 × 16, bitsliced for AES-256
//                                          future; phase 2a uses 11 × 128 = 1408)
...
//                                              tower-field S-box)
// 3392      65536     CHUNK_PT_BUFFER     (CTR/GCM stream input — phase 3+)
// 68928     65536     CHUNK_CT_BUFFER     (CTR/GCM stream output — phase 3+)
// 134464              END                 (< 196608 = 3 pages ✓)
//
...
export const CHUNK_PT_OFFSET:          i32 = 3392;
export const CHUNK_CT_OFFSET:          i32 = 68928;
// END = 134464 < 196608 ✓
