 ...
 *
 * Verifies that after a successful decapsulate call, every mlkem WASM
 ...
 *
 * Without these wipes the scratch bytes would persist in mlkem linear
 * memory until the next mlkem op or MlKem.dispose().
 */
...
function getExports(): MlKemExports {
