...
//
/**
 * sha3 scratch-region wipes across mlkem op boundaries.
 *
 ...
 * last sha3 call in every mlkem public path happens to be keyed on
...
describe('sha3 scratch wiped after every public mlkem op', () => {
...
describe('sha3 scratch wipe, belt-and-suspenders across parameter sets', () => {
	...
	// the wipes fire identically regardless of which mlkem params drove
	// the op.
