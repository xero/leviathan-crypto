...
//                           ▀█████▀▀
//
// test/unit/mlkem/poly_arithmetic.test.ts
//
// Gate-based tests for the mlkem WASM module. FIPS 203 ML-KEM polynomial
...
import {
	loadMlKem, getWasm, mem, readBytes, writeBytes,
...
describe('Gate 5, CBD and rejection sampling', () => {
	...
	test('cbd2 (eta=2): KAT, matches FIPS 203 Algorithm 7 reference for fixed input', () => {
		// Inline FIPS 203 §4.2.2 / pq-crystals/mlkem ref/cbd.c reference.
