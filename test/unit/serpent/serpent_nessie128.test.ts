 ...
 * Coverage: 1,028 encrypt + 1,028 decrypt vectors
 */
...
describe('NESSIE Serpent-128 vectors (1028 vectors)', () => {
	const vectors = parseNessieFile('serpent_nessie-128.txt');

	it('parses 1028 vectors', () => {
