...
//
/**
 * SealStream Serpent v2 Known-Answer Tests (cross-browser)
 *
 ...
 * Files:  vectors/sealstream_serpent_v2.ts (sc1, sc3, scf1)
 */
...
const serpentVectors: SealStreamSerpentV2Vector[] = [sc1, sc3, scf1];

test.beforeEach(async ({ page }) => {
	await page.goto(BASE);
});

test('SealStream KAT batch — Serpent v2 (SC1, SC3, SCF1)', async ({ page }) => {
